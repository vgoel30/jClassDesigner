...
import static maf.settings.AppPropertyType.LOAD_ERROR_MESSAGE;
import static maf.settings.AppPropertyType.LOAD_ERROR_TITLE;
import static maf.settings.AppPropertyType.LOAD_WORK_TITLE;
import static maf.settings.AppPropertyType.NEW_COMPLETED_MESSAGE;
import static maf.settings.AppPropertyType.NEW_COMPLETED_TITLE;
import static maf.settings.AppPropertyType.NEW_ERROR_MESSAGE;
import static maf.settings.AppPropertyType.NEW_ERROR_TITLE;
import static maf.settings.AppPropertyType.SAVE_COMPLETED_MESSAGE;
import static maf.settings.AppPropertyType.SAVE_COMPLETED_TITLE;
import static maf.settings.AppPropertyType.SAVE_ERROR_MESSAGE;
import static maf.settings.AppPropertyType.SAVE_ERROR_TITLE;
import static maf.settings.AppPropertyType.SAVE_UNSAVED_WORK_MESSAGE;
import static maf.settings.AppPropertyType.SAVE_UNSAVED_WORK_TITLE;
import static maf.settings.AppPropertyType.SAVE_WORK_TITLE;
import static maf.settings.AppPropertyType.WORK_FILE_EXT;
import static maf.settings.AppPropertyType.WORK_FILE_EXT_DESC;
import static maf.settings.AppStartupConstants.PATH_WORK;
...
public class AppFileController {
    ...
    /**
     * This method will save the current course to a file. Note that we already
     * know the name of the file, and the user is making a conscious decision to
