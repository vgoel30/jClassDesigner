...
public class TestSave3 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        ClassDiagramObject DateTask = new ClassDiagramObject("DateTask", "interface", methods2, variables2);
        DateTask.setX(300);
        DateTask.setY(54);
        ...
        ClassDiagramObject PauseHandler = new ClassDiagramObject("PauseHandler", "interface", methods3, variables3);
